...
namespace ProjetoRotaOeste.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "FinalidadesPergunta",
                columns: table => new
                {
                    IdFinalidade = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FinalidadesPergunta", x => x.IdFinalidade);
                    table.ForeignKey(
                        name: "FK_FinalidadesPergunta_Perguntas_PerguntaIdPergunta",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdRespostaItem = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    IdConversa = table.Column<int>(type: "integer", nullable: false),
                    IdPergunta = table.Column<int>(type: "integer", nullable: false),
                    TextoResposta = table.Column<string>(type: "text", nullable: false),
                    Ordem = table.Column<int>(type: "integer", nullable: false),
                    ConversaIdConversa = table.Column<int>(type: "integer", nullable: false),
                    PerguntaIdPergunta = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RespostasItem", x => x.IdRespostaItem);
                    table.ForeignKey(
                        name: "FK_RespostasItem_Conversas_ConversaIdConversa",
                        column: x => x.ConversaIdConversa,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FinalidadesPergunta_PerguntaIdPergunta",
                table: "FinalidadesPergunta",
