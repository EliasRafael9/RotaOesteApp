...
namespace ProjetoRotaOeste.Migrations
{
    ...
    [Migration("20241113214154_NewMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PerguntaUsuario", b =>
                {
                    b.Property<int>("PerguntaIdPergunta")
                        .HasColumnType("integer");

                    b.Property<string>("UserClientsId")
                        .HasColumnType("text");

                    b.HasKey("PerguntaIdPergunta", "UserClientsId");

                    b.HasIndex("UserClientsId");

                    b.ToTable("PerguntaUsuarios", (string)null);
                });
            ...
            modelBuilder.Entity("PerguntaUsuario", b =>
                {
                    b.HasOne("ProjetoRotaOeste.Models.Pergunta", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoRotaOeste.Models.RespostaItem", b =>
                {
                    b.HasOne("ProjetoRotaOeste.Models.Pergunta", "Pergunta")
                        .WithOne("RespostaItem")
                        .HasForeignKey("ProjetoRotaOeste.Models.RespostaItem", "IdPergunta")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProjetoRotaOeste.Models.Usuario", "Usuario")
                        .WithMany()
